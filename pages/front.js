...
const Front = () => {
  const dropdown = () => {
    let elems = document.querySelectorAll(".droh");
  ...
  return (
    <>
      <header className="bg-white dark:bg-gradient-to-r dark:from-slate-800 dark:via-gray-800 dark:to-zinc-800">
        <nav
        ...
        >
          ...
          <div className="hidden lg:flex lg:gap-x-12">
            <div className="relative">
              ...
              >
                Product
                <BiChevronDown className="text-xl droh" />
                <BiChevronUp className="text-xl droh hidden" />
              </button>
              <div className="droh hidden absolute -left-8 top-full z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl bg-white shadow-lg ring-1 ring-gray-900/5">
                <div className="p-4">
      ...
      <div className="bg-gradient-to-r from-teal-500 from-10% via-cyan-500 via-30% to-sky-500 to-90%  dark:from-slate-700 dark:via-gray-700 dark:to-zinc-700">
