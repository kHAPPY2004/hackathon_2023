          ...
          {faqdata.map((item) => (
            ...
            >
              <div
                ...
                className="text-white py-1 mx-10 pl-5 cursor-pointer rounded-md bg-gradient-to-r from-teal-500 from-30% via-cyan-500 via-60% to-sky-400 to-100%  dark:from-gray-600 dark:via-slate-700 dark:to-neutral-600 font-bold text-sm md:text-lg"
              >
                {item.data_id}
              </div>

              {openItemId === item.id && (
                <div className="bg-gray-100 text-sm md:text-lg font-medium p-4 mx-10 dark:bg-slate-700">
