...
const Front = () => {
  ...
  return (
    <>
      <section className="bg-gradient-to-r lll pt-10 from-teal-500 from-10% via-cyan-600 via-30% to-sky-500 to-90%  dark:from-slate-700 dark:via-gray-700 dark:to-zinc-700">
